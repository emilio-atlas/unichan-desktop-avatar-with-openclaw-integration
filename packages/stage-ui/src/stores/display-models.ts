...
// Nicole: load from unzipped directory (same as landing page) – more reliable than zip
const presetNicoleUrl = new URL('../assets/live2d/models/nicole/Nicole/Nicole.model3.json', import.meta.url).href
const presetNicolePreview = new URL('../assets/live2d/models/nicole/Nicole/Nicole.png', import.meta.url).href
// Nicole (Lite): 4096 textures for lower GPU usage
const presetNicoleLiteUrl = new URL('../assets/live2d/models/nicole/Nicole-4096/Nicole.model3.json', import.meta.url).href
const presetNicoleLitePreview = new URL('../assets/live2d/models/nicole/Nicole/Nicole.png', import.meta.url).href
const presetAliiumUrl = new URL('../assets/live2d/models/Aliium.zip', import.meta.url).href
const presetAliiumPreview = new URL('../assets/live2d/models/hiyori/preview.png', import.meta.url).href
...
const displayModelsPresets: DisplayModel[] = [
  { id: 'preset-live2d-nicole', format: DisplayModelFormat.Live2dDirectory, type: 'url', url: presetNicoleUrl, name: 'Nicole', previewImage: presetNicolePreview, importedAt: 1733113886840 },
  { id: 'preset-live2d-nicole-lite', format: DisplayModelFormat.Live2dDirectory, type: 'url', url: presetNicoleLiteUrl, name: 'Nicole (Lite)', previewImage: presetNicoleLitePreview, importedAt: 1733113886840 },
  ...
  { id: 'preset-live2d-aliium', format: DisplayModelFormat.Live2dZip, type: 'url', url: presetAliiumUrl, name: 'Aliium (Ariu)', previewImage: presetAliiumPreview, importedAt: 1733113886840 },
