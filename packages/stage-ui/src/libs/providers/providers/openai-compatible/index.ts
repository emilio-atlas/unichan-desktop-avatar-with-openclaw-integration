...
const defaultOpenAIBaseUrl = (typeof import.meta !== 'undefined' && (import.meta as any).env?.VITE_UNICHAN_GATEWAY_URL) || 'https://api.openai.com/v1'
