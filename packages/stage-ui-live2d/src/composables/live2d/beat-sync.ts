...
const defaultStyles: Record<BeatSyncStyleName, BeatStyleConfig> = {
  ...
  // sway uses a three-point path per beat: side A -> side B -> center (A-shape arcs); slightly stronger for visible idle life
  'sway-sine': { topYaw: 14, topRoll: 0, bottomDip: 0, swingLift: 14, pattern: 'sway' },
}
