  ...
  <ComboboxRoot v-model="modelValue" :class="['relative', 'w-full']">
    <ComboboxAnchor
      :class="[
        ...
        'border-neutral-300 dark:border-neutral-600 border-solid border-2 focus:border-primary-300 dark:focus:border-primary-400/50',
    ...
    <ComboboxPortal>
      <ComboboxContent
        ...
        :class="[
          ...
          'border-neutral-300 dark:border-neutral-600 border-solid border-2 focus:border-neutral-400 dark:focus:border-neutral-500',
        ]"
