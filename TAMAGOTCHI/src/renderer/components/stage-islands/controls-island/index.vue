...
<template>
  <div fixed bottom-2 right-2>
    <div flex flex-col gap-1>
      ...
      <ControlButtonTooltip>
        <ControlButton :button-style="adjustStyleClasses.button" @click="toggleChat">
          ...
          <div class="relative">
            <ControlButton :button-style="adjustStyleClasses.button">
              <Transition name="fade" mode="out-in">
                <IndicatorMicVolume v-if="enabled" :class="adjustStyleClasses.icon" color-class="text-emerald-600 dark:text-emerald-400" />
                <div v-else i-ph:microphone-slash :class="adjustStyleClasses.icon" class="text-neutral-500 dark:text-neutral-400" />
              </Transition>
            </ControlButton>
          </div>
