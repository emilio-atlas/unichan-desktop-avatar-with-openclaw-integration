...
const presetLive2dNicoleUrl = new URL('../assets/live2d/models/nicole.zip', import.meta.url).href
const presetLive2dNicolePreview = new URL('../assets/live2d/models/nicole/preview.png', import.meta.url).href
...
const displayModelsPresets: DisplayModel[] = [
  { id: 'preset-live2d-nicole', format: DisplayModelFormat.Live2dZip, type: 'url', url: presetLive2dNicoleUrl, name: 'Nicole (UNICHAN)', previewImage: presetLive2dNicolePreview, importedAt: 1733113886840 },
